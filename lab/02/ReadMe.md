...
В качестве стороннего сервиса реализовать приложение на языке Python, выполняющее следующие функции:
    ...
    Сохранение поступивших данных в excel-докумен

## Выполнение работы

В начале работы был создан навык на странице яндекса. Назвал своим именем.

![](./screens/Навык.PNG)

рисунок 1 название навыка
...
рисунок 2 работата навыка

![](./screens/помощь.PNG)

рисунок 3 раздел помощь

Далее была написана веб-страница управления вебхуками. На рисунке 4 видно хук клиента python, а так же хук с сайта управления вебхуками, необходимый для отладки.
...
## Вывод по работе. 
- Я научился работать с системой навыков Яндекс, создавать post запросы, читать из файлов, писать файлы excel из Python и улучшил знания и навыки работы в обоих языках программирования.
